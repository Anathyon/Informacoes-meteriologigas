...
import { fetchclima, WeatherData, fetchunsplash, fetchCidadePorCoordenadas } from './api.js'

const p_lo_hrs = document.querySelector("#p_lo_hrs") as HTMLElement
const weather = document.querySelector("#weather") as HTMLElement
const input_busca = document.querySelector("#input_busca") as HTMLInputElement
const bt_busca = document.querySelector("#bt_busca") as HTMLButtonElement
  
const e_cidade = document.createElement("p") as HTMLParagraphElement
const e_temp = document.createElement("p") as HTMLParagraphElement
const e_descri = document.createElement("p") as HTMLParagraphElement
const e_umidade = document.createElement("p") as HTMLParagraphElement
const e_vel_vento = document.createElement("p") as HTMLParagraphElement
const e_sugestao = document.createElement("p") as HTMLParagraphElement

const e_ic_descri_clima_limpo = document.createElement("img") as HTMLImageElement
const e_ic_descri_clima_limpo_noite = document.createElement("img") as HTMLImageElement
const e_ic_descri_clima_nublado = document.createElement("img") as HTMLImageElement
const e_ic_descri_clima_chuvoso = document.createElement("img") as HTMLImageElement
const e_ic_descri_clima_nevando = document.createElement("img") as HTMLImageElement
const e_ic_descri_nuvens_dispersas = document.createElement("img") as HTMLImageElement
const e_ic_descri_trovoadas = document.createElement("img") as HTMLImageElement
const e_ic_nevoa = document.createElement("img") as HTMLImageElement
const ic_umidade = document.createElement("img") as HTMLImageElement
const ic_vel_vento = document.createElement("img") as HTMLImageElement
const ic_ter_frio   = document.createElement("img") as HTMLImageElement
const ic_ter_quente = document.createElement("img") as HTMLImageElement
const ic_ter_medio  = document.createElement("img") as HTMLImageElement
const ic_ter_chuva = document.createElement("img") as HTMLImageElement
...
const imagem_de_fundo = async (cidade: string) => {
    try {
...
const mostrar_clima = async (cidade: string) => {
    try {
        const weatherdata: WeatherData = await fetchclima(cidade)
        weather.innerHTML = ""

        const sugestao_climatica = ():string|null => {
            try{
...
navigator.geolocation.getCurrentPosition(
    ...
    (error) => {
        ...
        const arry_estados_br: string[] = ["Acre","Amapá","Amazonas","Pará","Rondônia","Roraima","Tocantins","Alagoas",
...
weather.addEventListener("drag",(e) => {
    ...
    const elementos = Array.from (
        weather.querySelectorAll<HTMLElement>(".tam_svg")
      )
